...
{subTitle :'Step 05',
        ...
        body:<ul className="list-disc list-inside  text-text-default-default  md:text-lg font-normal  leading-normal"><li>- X (Twitter) Marketing Campaign</li><li> - YouTube Marketing Campaign for Vloggers</li><li>- SEO</li><li>- 25,000 token holder</li><li>- Telegram Marketing Campaign</li><li>- CoinMarketCap Listing</li><li>- CEX Listing</li><li>- CoinGecko Listing</li><li>- Celebrities onboarding program 2026</li></ul>
    }
]
