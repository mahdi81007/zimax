...
function Index({title, subTitle, time, children,height, className}) {
    ...
    return (
        <div className={classes.cards}>
            ...
            <div className={classes.info}>
                <div className={classes['gradiant-cart']} style={{height:height}}>{children}</div>
            <Center>
                    <Button
                        variant="subtle"
                        size="md"
            ...
            {isPc?(
                    <Modal opened={openModal} onClose={()=>setOpenModal(false)}
                           centered={true}
                           radius={'md'}
                           title={<div className={`w-full flex ${title?'justify-between':'justify-end'}  items-center text-Primary`}>{title}</div>}
                    >
