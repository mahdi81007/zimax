...
function Z3Calculator() {
    ...
    return (
        ...
        children={ <div>
            ...
            <p className="self-stretch justify-center text-text-default-default text-sm  leading-7">Basic NFT level program, which is best for those who are self-reliant and prefer independent development.</p>
